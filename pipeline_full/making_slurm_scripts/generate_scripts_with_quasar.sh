...
#SBATCH -o /fred/oz183/sberger/paper_2_obs_bias/src/pipeline_full/slurm_scripts/out_err_files/run_all_mags_${quasar_name}_${quasar_filter}.out
#SBATCH -e /fred/oz183/sberger/paper_2_obs_bias/src/pipeline_full/slurm_scripts/out_err_files/run_all_mags_${quasar_name}_${quasar_filter}.err
...
python /fred/oz183/sberger/paper_2_obs_bias/src/pipeline_full/run_mags_LARGE_SAMPLE_gal_wrapper.py JWST.NIRCAM.${filter} ${ss} ${mag_value} BY_WIDTH_${quasar_name}_${filter}_all_indices_sample_${galaxy_mag_min}_${galaxy_mag_max}.npy ${exp_time} 17
EOL
